...
def speedUp(tempData, tempBody):
    for n in range(len(tempBody)):
        print(tempBody[n]);
        print("CUDA EX:", tempData[0][n]/tempData[2][n])
        print("CUDA BH:", tempData[1][n]/tempData[3][n])
        print("MPI EX:",tempData[0][n]/tempData[4][n])
        print("MPI BH:",tempData[1][n]/tempData[5][n])
